...
// @dev Import ERC721, Counters, Access Control and Strings from OpenZeppelin contracts
...
contract ERC721Contract is ERC721, AccessControl {
    ...
    // @dev Override the supportsInterface function to ensure that the contract properly implements the required ERC721 and AccessControl interfaces
